  ...
  return(
    <div id= "container">
      <div id= "controls">
        ...
        <button id= "goalTeam1" onClick= {resets} className= "yellowButtons">
          Goal team 1
        </button>
        <button id= "goalTeam2" onClick= {resets} className = "yellowButtons">
          Goal team 2
        </button>
        <button id= "startSecondHalf" onClick= {resets} className = "yellowButtons">
          start second half
        </button>
